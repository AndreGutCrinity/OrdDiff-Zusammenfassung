...
\textbf{Example: Checking if a quantity is conserved}\\
...
This is true for $V(x) = -\frac{1}{4}x^4 + \frac{1}{2}x^2$ ($V(x)$ is the integral of the negative right side of the initial equation), and a conserved quantity is the total energy
\begin{equation}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{\linewidth / 2 - 0.5em}@{\hskip 1em}p{\linewidth / 2 - 0.5em}}
    \centering
    \includegraphics[width=0.8\linewidth]{Pics/4.16.png} &
    \includegraphics[width=0.8\linewidth]{Pics/4.34.png}\\
